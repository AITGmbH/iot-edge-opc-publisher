...
namespace OpcPublisher
{
    ...
    public interface IOpcSession : IDisposable
    {
        ...
        Task<HttpStatusCode> AddEventNodeForMonitoringAsync(NodeId nodeId, ExpandedNodeId expandedNodeId,
            ...
            OpcEventOnEndpointModel model);
            
        Task<HttpStatusCode> RequestEventNodeRemovalAsync(Guid id, CancellationToken ct, bool takeLock = true);
